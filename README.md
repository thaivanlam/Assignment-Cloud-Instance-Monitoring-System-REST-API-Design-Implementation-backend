...
role scoping and 128 functional tests.
...
[![Tests](https://img.shields.io/badge/tests-128%20passing-2EA043?style=flat-square&logo=pytest&logoColor=white)](docs/testing/FUNCTIONAL_TESTS.md)
...
| ✅ | **128 functional tests** | Driven over HTTP against a per-test in-memory database — no API key, no running server |
...
pytest -q          # 128 functional tests — no API key, no running server
```
